...
* [Google CodeLabs Tools Github](https://github.com/Noname-SA/claat-tool) - The repo that contains the claat tool we'll be using today
...
The instructions below are what worked for me on Mac, but you can also find instructions [here](https://github.com/Noname-SA/claat-tool/tree/master/claat) 
...
Install claat
``` bash
$ go get -u -v -x github.com/Noname-SA/claat-tool/claat
```
...
More Markdown Parser examples can be found [here](https://github.com/Noname-SA/claat-tool/tree/master/claat/parser/md).
...
Check it out here: [CodeLabs Site](https://github.com/Noname-SA/claat-tool/blob/master/site/README.md)
